...
namespace MQCloud {
    ...
    struct ExtensiabiletyEventsHandler {
        ...
        virtual void OnNodeAdvertisedTopic(const std::string &pattern,
                                           const std::string &topic,
                                           const std::string &node);

        virtual void OnNodeRejectedTopic(const std::string &pattern, const std::string &topic, const std::string &node);

        virtual void OnNodeSubscribedToTopic(const std::string &pattern,
                                             const std::string &topic,
                                             const std::string &node);

        virtual void OnNodeUnsubscribedFromTopic(const std::string &pattern,
                                                 const std::string &topic,
                                                 const std::string &node);

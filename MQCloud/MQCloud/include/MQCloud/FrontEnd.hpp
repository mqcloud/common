...
#include <MQCloud/Internal/ExchangeOperationsManager.hpp>
...
namespace MQCloud {
    ...
    public:
        ...
        void AdvertiseTopic(const std::string &pattern,
                            const std::string &topic,
                            std::shared_ptr<OnNodesAction> CurrentSubscribers) {
            systemEventsManager.exchangeEventsHandler
        ...
        void Subscribe(const std::string &pattern,
                       ...
                       std::shared_ptr<OnMessageAction> OnMessage);
        ...
        void RegisterResponseCalback(const std::string &pattern,
                                     const std::string &topic,
                                     int messageId,
                                     std::shared_ptr<OnMessageAction> OnMessage);
        ...
        void RegisterMultipleResponsesCalback(const std::string &pattern,
                                              const std::string &topic,
                                              int message_id,
                                              int timeoutDeadlineMilliseconds,
                                              std::shared_ptr<OnMessagesAction> OnMessage);

        void RegisterMultipleResponsesCalback(const std::string &pattern,
                                              const std::string &topic,
                                              int message_id,
                                              int timeoutDeadlineMilliseconds,
                                              std::function<void(std::vector<Message>)> OnMessage);
        ...
        void GetAllSubscribedNodes(const std::string &pattern,
                                   const std::string &topic,
                                   std::shared_ptr<OnNodesAction> OnResult) {
        ...
        int SetTopicNodeIdSelectionAlgorithm(const std::string &pattern,
                                             const std::string &topic,
                                             std::shared_ptr<OnMessageAlgorithmAction> algorithm);

        int SetTopicNodeIdSelectionAlgorithm(const std::string &pattern,
                                             const std::string &topic,
                                             std::function<std::string(const Message &)> algorithm);
